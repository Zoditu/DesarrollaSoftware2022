...
function AddProduct(props) {
 ...
 // inicializo las variables de categorias, subcategoria y tipo con null   
        ...
        <form onSubmit={function(e){
            ...
            <div className="input-group mb-3">
                ...
                <input required value={product.model || ''} onChange={function(e){
                    ...
                    setProduct(Object.assign({}, product));
                }} type="text" className="form-control" placeholder="Forma del producto" aria-label="Modelo del producto" aria-describedby="model" />
            </div>
            ...
            <div className="input-group mb-3">
                ...
                <input required value={product.color || ''} onChange={function(e){
                    ...
                    setProduct(Object.assign({}, product));
                }} type="text" className="form-control" placeholder="Sabor del producto" aria-label="Color del producto" aria-describedby="color" />
            </div>
                ...
                <section className="row w-100 h-100 align-items-center">
                    <div className="col">
                        ...
                        <button onClick={function(){
                                ...
                                type="button" className="btn add-image btn btnAdmin">
                            <span className="material-icons">
                                add_circle_outline
                            </span>
                        </button>
            ...
            <button className="btn w-100 btn btnAdmin">{props.product ? "Modificar Producto" : "Crear Producto"}</button>
        </form>
    </>
}
    ...
    var html = <>
        <form onSubmit={function(e){
            ...
            <div className="input-group">
                <button className="w-100 btn btnAdmin" type="submit">Search</button>
            </div>
        </form>
        <hr />
        ...
        <footer className="container p-0 text-center my-3">
            ...
            }} type="button" className="btn btnAdmin">
                &lt; Anterior
            </button>
...
function ModifyOrders(props) {
    ...
    var orderViewer = <h2 className="text-center encabezado">No hay datos de la orden...</h2>;
    if(orders !== null) {
        if(orders.length) {
                                    ...
                                    <div className="col">
                                        <div className="card-body">
                                            <form onSubmit={function(e){
                                                ...
                                                <button type="submit" className="w-100 btn btnAdmin ">Actualizar Orden</button>
                                            </form>
...
function Admin(props) {
    ...
    var buttons = <>
        <div className="card action-product">
            ...
            <div className="card-body">
                ...
                }} href="#" className="w-100 btn btnAdmin">Crear</a>
            </div>
        </div>
        ...
        <div className="card action-product">
            ...
            <div className="card-body">
                ...
                }} href="#" className="w-100 btn btnAdmin">Modificar</a>
            </div>
        </div>
        <hr />
        <div className="card action-product">
    ...
    switch(showForm) {
        ...
        case forms.MODIFY_ORDER:
            encabezado="Administrador de Ordenes"
