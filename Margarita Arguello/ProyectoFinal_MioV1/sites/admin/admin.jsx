...
//tipos
    ...
    return <>
        <form onSubmit={function(e){
                ...
                <section className="row w-100 h-100 align-items-center">
                    <div className="col">
                        ...
                        <button onClick={function(){
                                ...
                                type="button" className="btn add-image btnCrear">
                            <span className="material-icons">
                                add_circle_outline
                            </span>
                        </button>
            ...
            <button className="btn w-100 btnCrear">Crear Producto</button>
        </form>
    </>
}
    ...
    var buttons = <>
        <div className="card action-product">
            ...
            <div className="card-body">
                ...
                }} href="#" className="w-100 btn btnCrear">Crear</a>
            </div>
        </div>
        ...
        <div className="card action-product">
            ...
            <div className="card-body">
                ...
                }} href="#" className="w-100 btn btnCrear">Modificar</a>
            </div>
        </div>
    </>;
